...
while(page_number<140): 
     ...
     next_page='https://internshala.com/internships/work-from-home-jobs/page-' + str(page_number)
     ...
     for i in range(25):
        ...
        f.write("\n" + company + "|" + internshipname + " | " +location + " | " + duration + " | " + startDate + " | "+ stipend +" | "+ postedOn + " | " + applyby + " | " + ApplyNow + "\n")
